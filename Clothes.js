...
const dataRef = ref(database, 'clothes'); // Change 'medicines' to 'clothes'
...
// Reference to the user's food node
const userClothesRef = ref(database, `users/${currentUserId}/Clothes`);

// Save the food data directly without a unique ID
set(userClothesRef, newData);
